...
export default {
    ...
    themeConfig: {
        ...
        logo: '/logo.jpg',
        nav: [
            { text: '前端', link: '/Pages/FrontEnd/index', activeMatch: '/Pages/FrontEnd/' },
            { text: 'python', link: '/Pages/Python/index', activeMatch: '/Pages/Python/index' },
            { text: '后端', link: '/Pages/RearEnd/index', activeMatch: '/Pages/RearEnd/index' },
